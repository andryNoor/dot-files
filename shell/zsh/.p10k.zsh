# Generated by Powerlevel10k configuration wizard on 2022-06-15 at 16:58 WIB.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 07629.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# round separators, sharp heads, sharp tails, 2 lines, solid, left frame,
...
() {
  ...
  ## JoolakNET adds this to customize the above lines configureation
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=2 #default: 7, I change it to 2 -> Green 
  # Custom icon.
  # typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='⭐'
  # Character cheatsheet here : https://www.nerdfonts.com/cheat-sheet
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='' # Arch-Linux
  #typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='' # OpenSuse
  #typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='' # RedHat-Linux
  #typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='' # Linux
  #typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='' # Apple
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=0 #4
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=3 #254
  ...
  ##########################[ status: exit code of the last command ]###########################
  #---------------------------------------------------------------------------------------------
  #########################[ JoolakNET adds this line ]###########################################
  # To show color code on terminal, use :
  # #>: for i in {0..255}; do print -Pn "%K{$i}  %k%F{$i}${(l:3::0:)i}%f " ${${(M)$((i%6)):#3}:+$'\n'}; done
  # more info : https://github.com/romkatv/powerlevel10k/blob/master/README.md#how-do-i-change-prompt-colors
  # search for "To see how different colors look in your terminal, run the following command:" section.
  #
  # End of line
  #---------------------------------------------------------------------------------------------
  #
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=235 #235 -> black; 0 -> default: black [transparent; depends on terminal colorscheme]
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=2 #0
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=235 #1 #155 #3
  # Custom icon.
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=3 #0
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=0 #7
